...
import com.sm.sdk.myapplication.Constant;
import com.sm.sdk.myapplication.MainActivity;
import com.sm.sdk.myapplication.MyApplication;
...
//        int code = -1;
//        try {
//            code = CarryOutReaderCard.mBasicOptV2.setSysParam(AidlConstantsV2.SysParam.PINPAD_MODE, mode);
//            if (code < 0) {
